...
import { selectName } from "reducers/misc";
        ...
        <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
          <div className="pt-12 sm:pt-16 lg:pt-20">
            <h2 className="text-3xl text-gray-900 font-extrabold tracking-tight sm:text-4xl">
              Thank you for joining us {user ? user.split(" ")[0] : ""}!
            </h2>
            <div className="mt-6 text-gray-500 space-y-6">
              <p className="text-lg">
                Well done, you've just signed up to help a migrant successfully
                integrate to their community.
              </p>
              <p className="text-base leading-7">
                Lexii is very much engaged with promoting community engagement
                and cohesion through language exchange. We hope that you'll
                learn something new too and there is no better way than through
                conversations.
              </p>
              <p className="text-base leading-7">
                It is important to us that as a volunteer you have a mutually
                supportive experience with Lexii
              </p>
              ...
              <p>
                We welcome any feedback and encourage you to raise concerns or
                complaints directly with us.
              </p>
            </div>
          </div>
